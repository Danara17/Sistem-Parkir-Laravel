                ...
                <div class="sidepanel-inner d-flex flex-column">
                    ...
                    >
                        ...
                        >
                            ...
                            <li class="nav-item">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                <a class="nav-link active" href="{{route('inputkendaraan')}}">
                                    <span class="nav-icon">
        ...
        <div class="app-wrapper">
            <div class="pt-3 p-md-3 p-lg-4">
                <div class="container-xl">
                    <h1 class="app-page-title">Input Platnomor</h1>  
                    <div class="app-card shadow-sm py-3 px-5">
                        <div class="text-center">
                          <form class="row g-3 mt-1 mb-1" action="{{route('postinputkendaraan')}}" method="post">
                            {{ csrf_field() }}
                            <input type="text" name="idmall" value="{{auth()->user()->idmall}}" hidden>
                            <div class="col-9">
                              <label for="inputPassword2" class="visually-hidden">Platnomor</label>
                              <input class="form-control" id="inputPassword2" required name="platnomor" placeholder="Platnomor">
                            </div>
                            <div class="col-3">
                              <button type="submit" class="btn app-btn-primary mb-3">Add Platnomor</button>
                            </div>
                          </form>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table app-table-hover mb-0 text-center">
                                            <thead>
                                                <tr>
                                                    <th class="cell">No</th>
                                                    <th class="cell">PLatnomor</th>
                                                    <th class="cell">tanggal masuk</th>
                                                    <th class="cell">jam masuk</th>
                                            ...
                                            <tbody>
                                                ...
                                                @if(auth()->user()->idmall == 1)
                                                    ...
                                                    @foreach ($dataPTC as $kendaraan)
                                                    <tr>
                                                        <td class="cell">{{$loop->iteration}}</td>
                                                        <td class="cell">{{$kendaraan->platnomor}}</td>
                                                        <td class="cell">{{$kendaraan->tglmasuk}}</td>
                                                        <td class="cell">{{$kendaraan->jammasuk}}</td>
                                                    
                                                    </tr>   
                                                    @endforeach

                                                @elseif(auth()->user()->idmall == 2)

                                                    @foreach ($dataTP as $kendaraan)
                                                    <tr>
                                                        <td class="cell">{{$loop->iteration}}</td>
                                                        <td class="cell">{{$kendaraan->platnomor}}</td>
                                                        <td class="cell">{{$kendaraan->tglmasuk}}</td>
                                                ...
                                                @elseif(auth()->user()->idmall == 3)
                                                    
                                                    @foreach ($dataRoyal as $kendaraan)
                                                    <tr>
                                                        <td class="cell">{{$loop->iteration}}</td>
                                                        <td class="cell">{{$kendaraan->platnomor}}</td>
                                                        <td class="cell">{{$kendaraan->tglmasuk}}</td>
