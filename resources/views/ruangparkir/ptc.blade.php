                                ...
                                <li class="nav-item has-submenu">
                                    ...
                                    <div id="submenu-1" class="collapse submenu submenu-1 show" data-bs-parent="#menu-accordion">
                                        <ul class="submenu-list list-unstyled">
                                            <li class="submenu-item"><a class="submenu-link active" href="{{route('ruangparkirptc')}}">Pakuwon Trade Center</a></li>
            ...
            <div class="app-content pt-3 p-md-3 p-lg-4">
                <div class="container-xl">
                    <div class="row g-3 mb-4 align-items-center justify-content-between">
                        <div class="col-auto">
                            <h1 class="app-page-title mb-0">Ruang Parkir PTC</h1>
                        </div>
                        <div class="col-auto">
                                ...
                                <div class="app-card app-card-doc shadow-sm h-100">
                                    ...
                                    <div class="app-card-body p-3 has-card-actions">
                                        <h4 class="app-doc-title truncate mb-0">
                                            <a href="#file-link"
                                                >Ruang {{$ruang->lantai . $ruang->ruang}}</a
                                            >
                                        </h4>
                                        <div class="app-doc-meta">
                                            <ul class="list-unstyled mb-0">
                                                <li>
                                                    <span class="text-muted">Mobil :</span>{{$ruang->jumlah_kendaraan}}
                                                </li>
                                                <li>
                                                    <span class="text-muted">Kosong:</span>
                                                    {{10 - $ruang->jumlah_kendaraan}}
                                                </li>
                                            </ul>
                                        </div>
                                        <!--//app-doc-meta-->
                                        ...
                                        <div class="app-doc-meta">
                                            <ul class="list-unstyled mb-0">
                                                <li>
                                                    ...
                                                    {{$ruang->jumlah_kendaraan}}
                                                </li>
                                                <li>
                                                    <span class="text-muted">Kosong:</span>
                                                    {{$ruang->kapasitas - $ruang->jumlah_kendaraan}}
                                                </li>
                                            </ul>
                                        </div>
                                        <!--//app-doc-meta-->
