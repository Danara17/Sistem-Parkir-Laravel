                ...
                <div class="sidepanel-inner d-flex flex-column">
                    ...
                    >
                        ...
                        >
                            ...
                            <li class="nav-item">
                                <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                                <a class="nav-link active" href="{{route('laporankeuangan')}}">
                                    <span class="nav-icon">
            ...
            <div class="pt-3 p-md-3 p-lg-4">
                <div class="container-xl">
                    <div class="row g-3 mb-4 align-items-center justify-content-between">
                        <div class="col-auto">
                            <h1 class="app-page-title mb-0">Laporan Keuangan</h1>
                        </div>
                        <div class="col-auto">
                             <div class="page-utilities">
                                <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                    ...
                                    <div class="col-auto">						    
                                        <a class="btn app-btn-secondary" href="{{route('detaillaporankeuanganbulanan')}}">
                            ...
                            <div class="app-card app-card-orders-table shadow-sm mb-5">
                                <div class="app-card-body">
                                    <div class="table-responsive">
                                        <table
                                            class="table app-table-hover mb-0 text-center"
                                        >
                                            <thead>
                                                <tr>
                                                    <th class="cell">No</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>   
                                                    ...
                                                    <td class="cell">{{$data->tglkeluar}}</td>
                                                    <td class="cell">Rp. {{ number_format($data->total_biaya, 0, ',', '.') }}</td>
                                                    <td class="cell">
                                                        @if($data->idmall == 1)
                                                            PTC
                                                        @elseif($data->idmall == 2)
                                                            TP
                                                        @elseif($data->idmall == 3)
                                                            Royal
                                                        @endif
                                                    </td>
                                                    <td class="cell">
                                                        <a class="btn app-btn-primary" href="/laporankeuangan/{{$data->idmall}}/{{$data->tglkeluar}}">
