                        ...
                        <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
                            ...
                            <div class="app-card app-card-orders-table shadow-sm mb-5">
                                <div class="app-card-body">
                                    <div class="container">
                                        <a href="{{route('outkendaraan')}}" class="btn app-btn-secondary mt-3">back</a>
                                        <hr>
                                        <div class="container">
                                            <form action="{{route('postoutkendaraan')}}" method="post">
                                                {{ csrf_field() }}
                                                @foreach ($data as $kendaraan)
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-10">
                                                          <input type="text" name="biaya" readonly class="form-control-plaintext" id="staticEmail" value="Rp. {{ number_format($biaya, 0, ',', '.') }}">
                                                        </div>
                                                    </div>
                                                ...
                                                @endforeach
                                                <button class="btn btn-danger mt-3 mb-3" style="color: white" type="submit">Keluarkan Kendaraan</button>
