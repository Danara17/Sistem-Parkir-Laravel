        ...
        <div id="app-sidepanel" class="app-sidepanel sidepanel-hidden"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            <a class="app-logo" href="{{route('dashboard')}}"><img class="logo-icon me-2" src="{{asset('assets/images/app-logo.svg')}}" alt="logo"><span class="logo-text">PORTAL</span></a>
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title">Edit Admin {{$nama}}</h1>
			    <hr class="mb-4">
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">Tambah Pegawai Go Parkir</h3>
		                <div class="section-intro">
							Memperluas tim dan memberikan tanggung jawab baru kepada 
							anggota yang terpercaya merupakan langkah penting dalam
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    ...
							    <form class="settings-form" id="myForm" action="{{route('posteditpegawai')}}" method="post">
									@csrf
									...
									<div class="mb-3">
									    ...
									    <input type="password" name="password" class="form-control" id="setting-input-2" value="" required>
									</div>
									<div class="mb-3">
									    <label for="nama" class="form-label">Nama</label>
									    <input type="text" name="nama" class="form-control" id="nama" value="{{$user->name}}" required>
									</div>
								    <div class="mb-3">
								    ...
								    <div class="mb-3">
									    ...
									    <input type="text" name="nomor" class="form-control" id="nomor" value="{{$user->no_telp}}" required>
									</div>
								    <div class="mb-3">
									    <label for="role" class="form-label">Bagian</label>
										<select class="form-select border-highlight" name="role" id="role" aria-label="Default select example">
											
											@if ($user->role === 'PMasuk')
												<option value="PMasuk" selected>Petugas Masuk</option>
												<option value="PKeluar">Petugas Keluar</option>
												<option value="PRuang">Petugas Ruang</option>
											@elseif ($user->role === 'PKeluar')
												<option value="PMasuk">Petugas Masuk</option>
												<option value="PKeluar" selected>Petugas Keluar</option>
												<option value="PRuang">Petugas Ruang</option>
											@elseif ($user->role === 'PRuang')
												<option value="PMasuk">Petugas Masuk</option>
												<option value="PKeluar">Petugas Keluar</option>
												<option value="PRuang" selected>Petugas Ruang</option>
											@endif
											
										</select>					
									</div>
								    <div class="mb-3">
									    <label for="idmall" class="form-label">Mall</label>
										<select class="form-select border-highlight" name="idmall" id="idmall" aria-label="Default select example">
											
											@if ($user->idmall === 1)
												<option value="1" selected>Pakuwon Trade Center</option>
												<option value="2">Tunjungan Plaza</option>
												<option value="3">Royal Plaza</option>
											@elseif ($user->idmall === 2)
												<option value="1">Pakuwon Trade Center</option>
												<option value="2" selected>Tunjungan Plaza</option>
												<option value="3">Royal Plaza</option>
											@elseif ($user->idmall === 3)
												<option value="1">Pakuwon Trade Center</option>
												<option value="2">Tunjungan Plaza</option>
												<option value="3" selected>Royal Plaza</option>
											@endif
									...
									<div class="row">
										<div class="col-auto me-auto">
											<a href="{{route('users')}}" class="btn app-btn-secondary">Back</a>
										</div>
										<div class="col-auto">
